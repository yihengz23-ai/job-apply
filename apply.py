...
8. 关注行业（focus_industry）— 该岗位主要 cover 的行业/赛道，如"AI"、"半导体"、"医疗健康"、"消费"、"新能源"、"先进制造"、"TMT"、"硬科技"等；从 JD 中提取，提取不到则填空字符串
...
- 默认：YOUR_NAME-YOUR_RESEARCH_REPORT.pdf

3. 如果 JD 没要求研究材料，但你判断适合附：
- 也使用默认：YOUR_NAME-YOUR_RESEARCH_REPORT.pdf
    ...
    try:
        ...
        if attach_report:
            if not os.path.exists(REPORT_PATH):
                ...
                rpt_name = report_filename or "YOUR_NAME-YOUR_RESEARCH_REPORT.pdf"
